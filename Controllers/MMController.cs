...
namespace WebApplication4.Controllers
{
    public class MMController : Controller
    {
        ...
        public ActionResult AjaxTT()
        {
            Boolean flag = false;
            //string ss = Request["ContractName"];
            //ObservableCollection<ContractNameT> ct = SqlQuery.ContractVQueryByName(ss);
            //if (ct.Count == 0)
            //{
            //    flag = true;
            //}
            ...
            string sjs = jss.Serialize(new { valid = true });
            string sd = "valid";
            string sssss = "{" + sd + ",false}";
            return Json(sssss);
        }
